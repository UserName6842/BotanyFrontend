...
export const useTypePlant = defineStore("TypePlant", {
  ...
  getters: {
    getTypePlants: (state: TypePlantStore) => state.typePlants,
    getTotalCountTypePlants: (state: TypePlantStore) => state.totalCount,
    getTypePlant: (state: TypePlantStore) => state.typePlant,
    getIsLoading: (state: TypePlantStore) => state.loading,
  },
  actions: {
